...
export const FALLBACK_PROJECTS: Project[] = [
  {
    ...
    previewVariant: "shop",
    summary:
      "E-commerce de regalos digitales en producción, con pagos live, JWT y evolución activa sobre Vercel.",
    bullets: [
      ...
      "Producto activo con mejoras continuas de UX, checkout y operaciones",
    ],
  ...
  },
  {
    ...
    summary:
      "SaaS multi-tenant para centros de reparación, desplegado y en evolución activa.",
    bullets: [
      "Backend NestJS + Prisma + PostgreSQL",
      "Dockerizado con Nginx como reverse proxy",
      "CI/CD con GitHub Actions y deploy en Railway",
      "Producto vivo con arquitectura multi-tenant en expansión",
    ],
  ...
  },
  {
    ...
    previewVariant: "dash",
    summary:
      "Portfolio personal pixel-art desplegado en carlxs.dev, diseñado como embudo de conversión para recruiters.",
    bullets: [
      "Next.js App Router con diseño horizontal, ES/EN y Sanity Studio",
      "CV descargable, WhatsApp directo, analytics y metadata SEO",
      "Deploy productivo en Vercel con dominio carlxs.dev",
    ],
    stack: ["Next.js", "TypeScript", "Sanity", "Vercel", "Analytics"],
    hasDetail: true,
    repoUrl: "https://github.com/bluexdev/portfolio",
    demoUrl: "https://carlxs.dev",
    heroUrl: "/projects/portfolio/home.png",
    galleryUrls: [
    ...
    longDesc:
      "CARLXSDEV Portfolio es mi sitio personal llevado a producción como una experiencia pixel-art funcional: navegación horizontal, contenido bilingüe, integración con Sanity, descarga de CV, contacto por WhatsApp y eventos de conversión para medir interés real de recruiters.",
    metrics: [
      { k: "ROL", v: "Full-stack" },
      { k: "DEPLOY", v: "Vercel" },
      { k: "DOMINIO", v: "carlxs.dev" },
    ],
    impactMetrics: [
      { k: "SEO", v: "JSON-LD" },
      { k: "IDIOMAS", v: "ES/EN" },
    ...
    features: [
      "Sistema visual pixel-art responsive con navegación por secciones",
      "Sanity Studio personalizado para administrar contenido e imágenes",
      "Eventos de analytics para CV, WhatsApp, proyectos y secciones vistas",
      "Metadata, sitemap, JSON-LD, OG image y favicon propio",
    ],
  },
  {
    id: "asistente",
